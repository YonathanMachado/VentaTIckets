...
class ArtistasApplicationTests {
    ...
    @Test
    void actualizarEstado_cuandoEstadoEsValido_actualizaEstadoDelArtista() {
        // Given
        EstadoArtistaDTO dto = new EstadoArtistaDTO();
        ...
        // When
        Artista resultado = artistasService.actualizarEstado(1L, dto.getEstado());
