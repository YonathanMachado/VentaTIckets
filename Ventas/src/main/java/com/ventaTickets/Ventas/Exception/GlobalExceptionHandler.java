...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(VentaNotFoundException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(TicketNoDisponibleException.class)
    public ResponseEntity<Map<String, Object>> handleTicketNoDisponible(TicketNoDisponibleException ex) {
        return buildResponse(HttpStatus.CONFLICT, ex.getMessage());
    }

    @ExceptionHandler(VentaDuplicadaException.class)
    public ResponseEntity<Map<String, Object>> handleVentaDuplicada(VentaDuplicadaException ex) {
        return buildResponse(HttpStatus.CONFLICT, ex.getMessage());
    }
